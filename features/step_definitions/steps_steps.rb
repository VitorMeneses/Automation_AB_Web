When("o título da pagina deve ser {string}") do |titulo|
...
And("verifico se tem no estoque o item Faded Short Sleeve") do
    expect(page.find(:xpath, '//*[@id="center_column"]/ul/li/div/div[2]/span/span').text).to eq("In stock")
end
